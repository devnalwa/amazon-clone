...
function Header() {
    ...
    return (
        <div className='header'>
            <Link to="/"> {/* Establishing Link to HomePage by clicking on Amazon Logo*/}
                <img
            ...
            <div className="header_nav">
                <Link to={!user && '/login'}> {/* Establishing Link to Login Page, won't take you to login page upon signing out, only when signing in*/}
                ...
                <Link to="/checkout"> {/* Establishing Link to Checkout by clicking on basket icon*/}
                    <div className='header_optionsBasket'>
                        <ShoppingBasketIcon />
                        <span className="header_optionLineTwo header_basketCount">
                            {basket ?.length}
                        </span> {/* Setting the basket count number to dynamically change. ? is so if basket becomes undefined it doesnt throw error   */}
                    </div>
                </Link>
